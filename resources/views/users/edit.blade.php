      ...
      <div class="bg-white py-6 sm:py-8 lg:py-12">
        <div class="max-w-screen-2xl px-4 md:px-8 mx-auto">
          ...
          <div class="sm:col-span-2">
      	  ...
      	  <!-- 自己紹介 - body -->
          <div class="sm:col-span-2">
            <label for="email" class="inline-block text-gray-800 text-sm sm:text-base mb-2">自己紹介</label>
            <textarea name="user[email]" class="w-full h-64 bg-gray-50 text-gray-800 border focus:ring ring-indigo-300 rounded outline-none transition duration-100 px-3 py-2">{{ $user->body }}</textarea>
