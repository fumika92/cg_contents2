            ...
            <div class="main_contents">
              <article class="main_img">
                <div>
                  ...
                  <input type="text" name="post[title]" placeholder="タイトル名を入力してください" value="{{ old('post.title') }}">
                  <p class='title__error' style='color:red'>{{ $errors->first('post.title') }}</p>
                </div>
                <div>
                  <label for="body">作品の説明</label>
                  <textarea name="post[body]" placeholder="説明文を入力してください">{{ old('post.body') }}</textarea>
